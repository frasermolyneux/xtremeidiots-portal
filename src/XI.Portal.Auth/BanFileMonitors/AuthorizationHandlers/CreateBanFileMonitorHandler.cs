...
{
    public class CreateBanFileMonitorHandler : AuthorizationHandler<CreateBanFileMonitor, BanFileMonitorDto>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, CreateBanFileMonitor requirement, BanFileMonitorDto resource)
        {

...
{
    public class CreateFileMonitorHandler : AuthorizationHandler<CreateFileMonitor, FileMonitorDto>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, CreateFileMonitor requirement, FileMonitorDto resource)
        {

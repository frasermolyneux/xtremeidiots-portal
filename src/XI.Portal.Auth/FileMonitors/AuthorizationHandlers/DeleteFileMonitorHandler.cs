...
{
    public class DeleteFileMonitorHandler : AuthorizationHandler<DeleteFileMonitor, FileMonitorDto>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, DeleteFileMonitor requirement, FileMonitorDto resource)
        {

...
{
    public class EditFileMonitorHandler : AuthorizationHandler<EditFileMonitor, FileMonitorDto>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, EditFileMonitor requirement, FileMonitorDto resource)
        {

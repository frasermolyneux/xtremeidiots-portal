...
{
    public class DeleteRconMonitorHandler : AuthorizationHandler<DeleteRconMonitor, RconMonitorDto>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, DeleteRconMonitor requirement, RconMonitorDto resource)
        {

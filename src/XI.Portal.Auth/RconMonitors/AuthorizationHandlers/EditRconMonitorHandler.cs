...
{
    public class EditRconMonitorHandler : AuthorizationHandler<EditRconMonitor, RconMonitorDto>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, EditRconMonitor requirement, RconMonitorDto resource)
        {
